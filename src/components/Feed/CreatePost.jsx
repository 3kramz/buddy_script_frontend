...
// Reuse the same Avatar helper from TimelinePost
...
const CreatePost = ({ onPostCreated }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            // Step 1: upload image to ImgBB from the browser, get back CDN URL
            let imageUrl = null;
            if (image) {
            ...
            // Step 2: send post data + CDN URL as plain JSON to our backend
                ...
                <form onSubmit={handleSubmit}>
                    <div className="_feed_inner_text_area_box">
                        <div className="_feed_inner_text_area_box_image">
                            <Avatar name={`${user.firstName || ''} ${user.lastName || ''}`.trim()} size={40} />
                        </div>
                    ...
                    {imagePreview && (
                        <div style={{ position: 'relative', marginTop: 12, marginBottom: 8 }}>
                            <img src={imagePreview} alt="Preview" style={{ width: '100%', maxHeight: 280, objectFit: 'cover', borderRadius: 8 }} />
                    ...
                    {error && <p style={{ color: '#dc3545', fontSize: 13, marginTop: 6 }}>{error}</p>}
                    ...
                    <div className="_feed_inner_text_area_bottom">
                        <div className="_feed_inner_text_area_item">
                            ...
                            <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
                                <button type="submit" disabled={loading || uploadingImage} className="_feed_inner_text_area_btn_link" style={{ opacity: (loading || uploadingImage) ? 0.7 : 1 }}>
                    ...
                    <div className="_feed_inner_text_area_bottom_mobile">
                        <div className="_feed_inner_text_mobile">
                            ...
                            <div className="_feed_inner_text_area_btn">
                                <button type="submit" disabled={loading} className="_feed_inner_text_area_btn_link" style={{ opacity: loading ? 0.7 : 1 }}>
                                    <svg className="_mar_img" xmlns="http://www.w3.org/2000/svg" width="14" height="13" fill="none" viewBox="0 0 14 13">
                                        <path fill="#fff" fillRule="evenodd" d="M6.37 7.879l2.438 3.955a.335.335 0 00.34.162c.068-.01.23-.05.289-.247l3.049-10.297a.348.348 0 00-.09-.35.341.341 0 00-.34-.088L1.75 4.03a.34.34 0 00-.247.289.343.343 0 00.16.347L5.666 7.17 9.2 3.597a.5.5 0 01.712.703L6.37 7.88zM9.097 13c-.464 0-.89-.236-1.14-.641L5.372 8.165l-4.237-2.65a1.336 1.336 0 01-.622-1.331c.074-.536.441-.96.957-1.112L11.774.054a1.347 1.347 0 011.67 1.682l-3.05 10.296A1.332 1.332 0 019.098 13z" clipRule="evenodd"></path>
                                    </svg>
