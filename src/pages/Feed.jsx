...
const Feed = () => {
    ...
    const [isTimelineDropShow1, setTimelineDropShow1] = React.useState(false);
    const [isTimelineDropShow2, setTimelineDropShow2] = React.useState(false);
		...
		<div className="_main_layout">
			...
			<nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
				<div className="container _custom_container">
					...
					<button className="navbar-toggler bg-light" type="button" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" onClick={() => setMobileMenuOpen(!isMobileMenuOpen)}> <span className="navbar-toggler-icon"></span>
					</button>
					<div className={`collapse navbar-collapse ${isMobileMenuOpen ? 'show' : ''}`} id="navbarSupportedContent">
						...
						<ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
							<li className="nav-item _header_nav_item">
								<a className="nav-link _header_nav_link_active _header_nav_link" aria-current="page" href="feed.html">
									<svg xmlns="http://www.w3.org/2000/svg" width="18" height="21" fill="none" viewBox="0 0 18 21">
										...
										<path className="_home_active" stroke="#000" strokeOpacity=".6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M11.857 19.341v-5.857a1 1 0 00-1-1H7.143a1 1 0 00-1 1v5.857"></path>
									</svg>
								</a>
							</li>
							<li className="nav-item _header_nav_item">
							...
							<li className="nav-item _header_nav_item">
								<span id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" onClick={() => setNotifyDropShow(!isNotifyDropShow)} style={{cursor: 'pointer'}}>
									...
									<div id="_notify_drop" className={`_notification_dropdown ${isNotifyDropShow ? 'show' : ''}`}>
						...
						<div className="_header_nav_profile">
							...
							<div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${isProfileDropShow ? 'show' : ''}`}>
											...
											<div className="_nav_drop_info">
												<span>
													<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
														<path stroke="#377DFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M10 19a9 9 0 100-18 9 9 0 000 18z"></path>
														<path stroke="#377DFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M7.38 7.3a2.7 2.7 0 015.248.9c0 1.8-2.7 2.7-2.7 2.7M10 14.5h.009"></path>
													</svg>												
												</span>
												Help &amp; Support		
											</div>
									...
									<li className="_mobile_navigation_bottom_item">
										<a href="feed.html" className="_mobile_navigation_bottom_link _mobile_navigation_bottom_link_active">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="27" fill="none" viewBox="0 0 24 27">
												...
												<path fill="#fff" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.07 18.497h5.857v7.253H9.07v-7.253z"></path>
											</svg>																						
										</a>
									</li>
									<li className="_mobile_navigation_bottom_item">
								...
								<div className="_layout_left_sidebar_inner">
									<div className="_left_inner_area_event _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
										...
										<a className="_left_inner_event_card_link" href="event-single.html">
											</a><div className="_left_inner_event_card"><a className="_left_inner_event_card_link" href="event-single.html">
												...
												</a><div className="_left_inner_event_bottom"><a className="_left_inner_event_card_link" href="event-single.html">
													<p className="_left_iner_event_bottom">17 People Going</p> </a><a href="#0" className="_left_iner_event_bottom_link">Going</a>
												</div>
											</div>
									...
									<div className="_feed_inner_ppl_card_mobile _mar_b16">
										<div className="_feed_inner_ppl_card_area">
											<ul className="_feed_inner_ppl_card_area_list">
												...
												<li className="_feed_inner_ppl_card_area_item">
													<a href="#0" className="_feed_inner_ppl_card_area_link">
														</a><a href="#0" className="_feed_inner_ppl_card_area_link">
															<div className="_feed_inner_ppl_card_area_story_active">
																<img src="assets/images/mobile_story_img1.png" alt="Image" className="_card_story_img1" />
															</div>
															<p className="_feed_inner_ppl_card_area_txt">Ryan...</p>
											...
											<div className="_feed_inner_timeline_post_top">
												...
												<div className="_feed_inner_timeline_post_box_dropdown">
													<div className="_feed_timeline_post_dropdown">
														<button type="button" href="#0" id="_timeline_show_drop_btn" className="_feed_timeline_post_dropdown_link" onClick={() => setTimelineDropShow1(!isTimelineDropShow1)}>
															<svg xmlns="http://www.w3.org/2000/svg" width="4" height="17" fill="none" viewBox="0 0 4 17">
																<circle cx="2" cy="2" r="2" fill="#C4C4C4"></circle>
																<circle cx="2" cy="8" r="2" fill="#C4C4C4"></circle>
																<circle cx="2" cy="15" r="2" fill="#C4C4C4"></circle>
													...
													<div id="_timeline_drop" className={`_feed_timeline_dropdown _timeline_dropdown ${isTimelineDropShow1 ? 'show' : ''}`}>
									...
									<div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
										<div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
											<div className="_feed_inner_timeline_post_top">
												...
												<div className="_feed_inner_timeline_post_box_dropdown">
													<div className="_feed_timeline_post_dropdown">
														<button type="button" href="#0" className="_feed_timeline_post_dropdown_link" onClick={() => setTimelineDropShow2(!isTimelineDropShow2)}>
															<svg xmlns="http://www.w3.org/2000/svg" width="4" height="17" fill="none" viewBox="0 0 4 17">
																<circle cx="2" cy="2" r="2" fill="#C4C4C4"></circle>
																<circle cx="2" cy="8" r="2" fill="#C4C4C4"></circle>
																<circle cx="2" cy="15" r="2" fill="#C4C4C4"></circle>
													...
													<div className={`_feed_timeline_dropdown ${isTimelineDropShow2 ? 'show' : ''}`}>
														<ul className="_feed_timeline_dropdown_list">
															<li className="_feed_timeline_dropdown_item">
																<a href="#0" className="_feed_timeline_dropdown_link">
																	<span>
